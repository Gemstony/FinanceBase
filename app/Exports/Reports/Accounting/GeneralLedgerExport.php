...
class GeneralLedgerExport implements WithMultipleSheets
{
    ...
    private function summarySheet(): GenericArrayExport
    {
        ...
        $rows = [
            ...
            ['Period Total Debit', number_format((float) ($totals['period_debit'] ?? 0), 2)],
            ['Period Total Credit', number_format((float) ($totals['period_credit'] ?? 0), 2)],
    ...
    private function transactionsSheet(): GenericArrayExport
    {
        ...
        foreach (($this->report['transactions_all'] ?? []) as $t) {
            $rows[] = [
                ...
                'Debit' => number_format((float) ($t['debit'] ?? 0), 2),
                'Credit' => number_format((float) ($t['credit'] ?? 0), 2),
