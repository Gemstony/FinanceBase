...
class IncomeSummaryExport implements WithMultipleSheets
{
    ...
    private function summarySheet(): GenericArrayExport
    {
        ...
        $rows = [
            ...
            ['Income Account', (string) ($filters['income_account_id'] ?? '')],
            ['', ''],
            ...
            ['Total Income', number_format((float) ($totals['total_income'] ?? 0), 2)],
            ['Previous Total', number_format((float) ($totals['previous_total_income'] ?? 0), 2)],
            ['Difference', number_format((float) ($totals['difference_total_income'] ?? 0), 2)],
        ];
