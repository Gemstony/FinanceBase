...
use App\Exports\Reports\DelinquencyExport;
use App\Models\LoanProducts;
use App\Models\SubShop;
use App\Models\User;
use App\Services\Reports\DelinquencyReportService;
...
class DelinquencyReportController extends \App\Http\Controllers\Controller
{
    public function __construct(
        private readonly DelinquencyReportService $service,
    ) {
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('reports.loans.delinquency', [
            ...
            'filters' => $filters,
            'report' => $report,
            'exportUrl' => route('reports.delinquency.export', array_merge(['format' => 'xlsx'], $commonParams)),
            'pdfUrl' => route('reports.delinquency.export', array_merge(['format' => 'pdf'], $commonParams)),
        ]);
    }
    ...
    public function export(Request $request, string $format = 'xlsx')
    {
        ...
        $filenameBase = 'delinquency-report-' . now()->format('Y-m-d-His');
        ...
        $export = new DelinquencyExport($report);
