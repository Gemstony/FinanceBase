...
use App\Exports\Reports\InternalPortfolioAnalysisExport;
use App\Models\LoanProducts;
use App\Models\SubShop;
use App\Models\User;
use App\Services\Reports\InternalPortfolioAnalysisService;
...
class InternalPortfolioAnalysisController extends \App\Http\Controllers\Controller
{
    public function __construct(
        private readonly InternalPortfolioAnalysisService $service,
    ) {
    }
    ...
    public function index(Request $request)
    {
        ...
        $filters = [
            ...
            'customer_segment' => $request->query('customer_segment'),
        ];
        ...
        return view('reports.internal_portfolio_analysis', [
            ...
            'filters' => $filters,
            'report' => $data,
            'exportUrl' => route('reports.internal_portfolio_analysis.export', array_filter([
                'format' => 'xlsx',
            ...
            'pdfUrl' => route('reports.internal_portfolio_analysis.export', array_filter([
                'format' => 'pdf',
                'date_from' => $dateFrom->toDateString(),
                'date_to' => $dateTo->toDateString(),
                'subshop_id' => $subshopId,
    ...
    public function export(Request $request, string $format = 'xlsx')
    {
        ...
        $filenameBase = 'internal-portfolio-analysis-' . now()->format('Y-m-d-His');
        ...
        $export = new InternalPortfolioAnalysisExport($data);
