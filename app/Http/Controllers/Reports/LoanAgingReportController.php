...
use App\Exports\Reports\LoanAgingExport;
use App\Models\LoanProducts;
use App\Models\SubShop;
use App\Models\User;
use App\Services\Reports\LoanAgingReportService;
...
class LoanAgingReportController extends \App\Http\Controllers\Controller
{
    public function __construct(
        private readonly LoanAgingReportService $service,
    ) {
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('reports.loans.loan_aging', [
            ...
            'filters' => $filters,
            'report' => $report,
            'exportUrl' => route('reports.loan_aging.export', array_merge(['format' => 'xlsx'], $commonParams)),
            'pdfUrl' => route('reports.loan_aging.export', array_merge(['format' => 'pdf'], $commonParams)),
        ]);
    }
    ...
    public function export(Request $request, string $format = 'xlsx')
    {
        ...
        $filenameBase = 'loan-aging-report-' . now()->format('Y-m-d-His');
        ...
        $export = new LoanAgingExport($report);
