...
use App\Exports\Reports\NplReportExport;
use App\Models\LoanProducts;
use App\Models\SubShop;
use App\Models\User;
use App\Services\Reports\NplReportService;
...
class NplReportController extends \App\Http\Controllers\Controller
{
    public function __construct(
        private readonly NplReportService $service,
    ) {
    }
    ...
    public function index(Request $request)
    {
        ...
        $filters = [
            ...
            'dpd_threshold' => $request->integer('dpd_threshold') ?: 90,
        ...
        $commonParams = array_filter([
            ...
            'dpd_threshold' => $filters['dpd_threshold'],
        ...
        return view('reports.npl', [
            ...
            'filters' => $filters,
            'report' => $report,
            'exportUrl' => route('reports.npl.export', array_merge(['format' => 'xlsx'], $commonParams)),
            'pdfUrl' => route('reports.npl.export', array_merge(['format' => 'pdf'], $commonParams)),
        ]);
    }
    ...
    public function export(Request $request, string $format = 'xlsx')
    {
        ...
        $filenameBase = 'npl-report-' . now()->format('Y-m-d-His');
        ...
        $export = new NplReportExport($report);
