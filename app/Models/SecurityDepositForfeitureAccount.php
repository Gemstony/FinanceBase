...
class SecurityDepositForfeitureAccount extends Model
{
    ...
    /**
     * Get forfeiture account for a specific shop
     */
    ...
    /**
     * Check if shop has forfeiture account configured
     */
    ...
    /**
     * Get forfeiture account for a specific subshop (uses parent shop)
    ...
    /**
     * Check if subshop has forfeiture account configured (uses parent shop)
