...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Check if data migration is needed (shop_id is null for any records)
        $hasNullShopId = DB::table('customer_credit_liability_accounts')
            ->whereNull('shop_id')
            ->exists();
        ...
        // If subshop_id is still present, remove it (FK -> indexes -> column)
        ...
        // Ensure shop-level unique and index exist
