    ...
    <div>
        <div class="btn-group mr-2">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('accounting.account_class.export', 'excel') }}">
                    <i class="fas fa-file-excel text-success"></i> Export to Excel
                </a>
                <a class="dropdown-item" href="{{ route('accounting.account_class.export', 'pdf') }}">
            ...
            <div class="card mt-4">
                <div class="card-header">
                    <a class="d-flex align-items-center justify-content-between text-decoration-none" data-toggle="collapse" href="#importCollapse" role="button" aria-expanded="false" aria-controls="importCollapse">
                        <h5 class="mb-0 text-dark"><i class="fas fa-file-import"></i> Import Account Classes</h5>
                            ...
                            <div class="col-md-8">
                                <div class="card border">
                                    <div class="card-header bg-info text-white">
                                        <h5 class="mb-0"><i class="fas fa-upload"></i> Bulk Import Account Classes</h5>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('accounting.account_class.import') }}" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mb-4">
                                                <a href="{{ route('accounting.account_class.download-template') }}" class="btn btn-outline-success">
                                                    <i class="fas fa-download"></i> Download Excel Template
                                                </a>
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="fas fa-file-import"></i> Import Account Classes
                                                </button>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="card border-warning">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="small">
                                            <li><strong>Code</strong> - Unique code for the account class (e.g., 1, 2, 3)</li>
                                            <li><strong>Name</strong> - Name of the account class</li>
                                        </ul>
        
                                        <h6 class="fw-bold mt-3">Optional Columns:</h6>
                                        <ul class="small">
                                            <li><strong>Description</strong> - Description of the account class</li>
...
$(document).ready(function() {
    ...
    Swal.fire({
        icon: 'error',
        title: 'Import Errors!',
        html: 'The import failed due to errors. Please check the error list below the table.',
        showConfirmButton: true
    });
    @endif
});
