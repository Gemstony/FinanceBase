...
<head>
    ...
    <title>Account Classes - {{ $subshop->name }}</title>
    <style>
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            <div class="report-title">Account Classes</div>
    ...
    <table class="kpi">
        <tr>
            <td>
                <div class="kpi-label">Total Account Classes</div>
    ...
    <div class="block-title">Account Classes List</div>
    <table>
        <thead>
            <tr>
                <th>#</th>
        ...
        <tbody>
            @forelse($accountClasses as $index => $class)
                <tr>
                    ...
                    <td>{{ $class->is_active ? 'Active' : 'Inactive' }}</td>
                    <td>{{ $class->created_at->format('M d, Y') }}</td>
                </tr>
            @empty
                <tr>
                    <td colspan="6" style="text-align:center; color:#777; padding:10px;">No account classes found</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="footer">
        <div class="footer-left">
            <strong>{{ $shopName }}</strong> | Account Classes Report
        </div>
