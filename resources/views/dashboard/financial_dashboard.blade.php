...
<div class="card border-0 shadow-lg mb-4"
    style="background: var(--sidebar-bg); color: white; border: none; margin-bottom: 20px;">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8">
                <div class="d-flex align-items-center mb-3">
                    <div class="me-3">
                        <div class="rounded-circle bg-opacity-25 p-3 d-inline-flex align-items-center justify-content-center"
...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card  border-0 mb-4">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    ...
                    Filters <i class="fas fa-info-circle text-muted" data-toggle="tooltip"
                        title="Filter dashboard data based on date range and branch"></i>
                </h5>
            </div>
            <div class="card-body py-3">
                <form method="GET" class="row g-3 align-items-end">
                    ...
                    <!-- From Date -->
                    <div class="col-md-2">
                        <label class="form-label fw-semibold text-muted small"><i class="fas fa-calendar text-danger"></i>
                            From</label>
                        ...
                        <div class="alert alert-{{ $alert['type'] }} alert-dismissible fade show" role="alert">
                            ...
                            @if(isset($alert['action_url']))
                                <a href="{{ $alert['action_url'] }}"
                                    class="btn btn-sm btn-{{ $alert['type'] == 'danger' ? 'outline-danger' : 'outline-warning' }}">
                                    View Details
                                </a>
                            @endif
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">
                            ...
                            Quick Actions <i class="fas fa-info-circle text-muted" data-toggle="tooltip"
                                title="Shortcuts to common tasks"></i>
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-2">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                                <a href="{{ route('loans.loans.create') }}"
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                                <a href="{{ route('loan.repayments.index') }}"
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                                <a href="{{ route('reports.loan_reports.index') }}"
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-6">
                                <a href="{{ route('reports.accounting_reports.index')}}"
        ...
        <div class="row mb-4" id="action-cards-container">
            <div class="col-md-4">
                <div class="card border-0 shadow-sm" data-loading="promises">
                    <!-- Skeleton Loader -->
                    <div class="card-body skeleton-loader" style="display: none;">
                        <div class="d-flex justify-content-between align-items-center">
                            <div style="width: 70%;">
                                <div class="skeleton skeleton-text mb-2" style="width: 80%;"></div>
                                <div class="skeleton skeleton-number"></div>
                            </div>
                            <div class="skeleton" style="width: 80px; height: 30px;"></div>
                        </div>
                    </div>
                    <!-- Actual Content -->
                    <div class="card-body content-loaded">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div
                                    class="h3 mb-0 font-weight-bold {{ $pendingPromisesTodayCount > 0 ? 'text-warning' : 'text-success' }}">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm" data-loading="approvals">
                    <!-- Skeleton Loader -->
                    <div class="card-body skeleton-loader" style="display: none;">
                        <div class="d-flex justify-content-between align-items-center">
                            <div style="width: 70%;">
                    ...
                    <div class="card-body content-loaded">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div
                                    class="h3 mb-0 font-weight-bold {{ $pendingApprovalsCount > 0 ? 'text-warning' : 'text-success' }}">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm" data-loading="disbursements">
                    <!-- Skeleton Loader -->
                    <div class="card-body skeleton-loader" style="display: none;">
                        <div class="d-flex justify-content-between align-items-center">
                            <div style="width: 70%;">
                    ...
                    <div class="card-body content-loaded">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div
                                    class="h3 mb-0 font-weight-bold {{ $pendingDisburseCount > 0 ? 'text-warning' : 'text-success' }}">
            ...
            <div class="col-md-4">
                <div class="card border-0 shadow-sm" data-loading="restructures">
                    <!-- Skeleton Loader -->
                    <div class="card-body skeleton-loader" style="display: none;">
                        <div class="d-flex justify-content-between align-items-center">
                            <div style="width: 70%;">
                    ...
                    <div class="card-body content-loaded">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <div
                                    class="h3 mb-0 font-weight-bold {{ $pendingRestructureCount > 0 ? 'text-warning' : 'text-success' }}">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="h4 mb-0">
                                        {{ number_format($dashboardData['kpis']['loan_portfolio'] ?? 0, 0) }}</div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="h4 mb-0">{{ number_format($dashboardData['kpis']['total_income'] ?? 0, 0) }}
                                    </div>
                                </div>
        ...
        <div class="row mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="h4 mb-0">
                                        {{ number_format($dashboardData['kpis']['total_expenses'] ?? 0, 0) }}</div>
                                </div>
            ...
            <div class="col-md-4">
                <a href="{{ route('reports.accounting.profit_loss.index') }}" class="text-decoration-none">
                    <div
                        class="card text-white {{ ($dashboardData['kpis']['net_profit'] ?? 0) >= 0 ? 'bg-success' : 'bg-danger' }}">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="text-uppercase small">Net Profit</div>
                                    <div class="h4 mb-0">{{ number_format($dashboardData['kpis']['net_profit'] ?? 0, 0) }}
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="h4 mb-0">{{ number_format($dashboardData['kpis']['cash_balance'] ?? 0, 0) }}
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="h4 mb-0">
                                        {{ number_format((int) ($dashboardData['customer_stats']['total_registered_customers'] ?? 0)) }}
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="h5 mb-0">
                                        {{ number_format((float) ($dashboardData['customer_stats']['total_customer_deposits'] ?? 0), 0) }}
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="h4 mb-0">
                                        {{ number_format((int) ($dashboardData['loan_portfolio']['total_released_loans'] ?? 0)) }}
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="h4 mb-0">
                                        {{ number_format((int) ($dashboardData['loan_portfolio']['total_active_loans'] ?? 0)) }}
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="h4 mb-0">
                                        {{ number_format((int) ($dashboardData['loan_portfolio']['total_completed_loans'] ?? 0)) }}
                                    </div>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <div class="h4 mb-0">
                                        {{ number_format((int) ($dashboardData['loan_portfolio']['total_restructured_loans'] ?? 0)) }}
                                    </div>
                                </div>
                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <div class="row text-center">
                            <div class="col-md-4">
                                <div
                                    class="display-4 {{ ($dashboardData['par_data']['par30'] ?? 0) > 10 ? 'text-danger' : (($dashboardData['par_data']['par30'] ?? 0) > 5 ? 'text-warning' : 'text-success') }}">
                            ...
                            <div class="col-md-4">
                                <div
                                    class="display-4 {{ ($dashboardData['par_data']['par60'] ?? 0) > 10 ? 'text-danger' : (($dashboardData['par_data']['par60'] ?? 0) > 5 ? 'text-warning' : 'text-success') }}">
                            ...
                            <div class="col-md-4">
                                <div
                                    class="display-4 {{ ($dashboardData['par_data']['par90'] ?? 0) > 10 ? 'text-danger' : (($dashboardData['par_data']['par90'] ?? 0) > 5 ? 'text-warning' : 'text-success') }}">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card" data-loading="transactions">
                <div class="card-header">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <div class="table-loading-overlay" id="transactions-loader" style="display: none;">
...
@push('css')
    ...
    <style>
        ...
        /* Content visibility for loading states */
        .loading-content {
            opacity: 0.5;
            pointer-events: none;
...
@section('js')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            /**
             * Hide chart loader and show canvas
            ...
            /**
             * Toggle card loading state (skeleton vs content)
             * @param {string} cardType - The data-loading attribute value
             * @param {boolean} isLoading - True to show skeleton, false to show content
             */
            function toggleCardLoading(cardType, isLoading) {
                const card = document.querySelector(`[data-loading="${cardType}"]`);
                if (card) {
                    const skeleton = card.querySelector('.skeleton-loader');
                    const content = card.querySelector('.content-loaded');
                    if (skeleton && content) {
            ...
            /**
             * Toggle table loading overlay
             * @param {string} tableId - The table loader ID
            ...
            // Simulate loading states on page load (remove in production for server-rendered content)
            // These show skeletons briefly then reveal content for visual feedback
            setTimeout(() => {
                toggleCardLoading('promises', false);
                toggleCardLoading('approvals', false);
                toggleCardLoading('disbursements', false);
                toggleCardLoading('restructures', false);
            }, 300);
            ...
            if (incomeVsExpensesCtx) {
                ...
                hideChartLoader('incomeVsExpensesChart');
            }
            ...
            if (incomeDistCtx) {
                ...
                hideChartLoader('incomeDistributionChart');
            }
            ...
            if (expenseDistCtx) {
                ...
                hideChartLoader('expenseDistributionChart');
            }
            ...
            if (profitTrendCtx) {
                ...
                hideChartLoader('profitTrendChart');
            }
            ...
            if (branchPerfCtx) {
                ...
                hideChartLoader('branchPerformanceChart');
            }
            ...
            if (loansReleasedCtx) {
                ...
                hideChartLoader('loansReleasedChart');
            }
            ...
            if (loansCollectionsCtx) {
                ...
                hideChartLoader('loansCollectionsChart');
            }
            ...
            if (customerStatusCtx) {
                ...
                hideChartLoader('customerStatusChart');
            }
            ...
            if (loanAmountStatusCtx) {
                ...
                hideChartLoader('loanAmountStatusChart');
            }
        });
    </script>
