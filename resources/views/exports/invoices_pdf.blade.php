...
<head>
    <meta charset="UTF-8">
    <title>{{ $subshop->name ?? 'Shop' }} Invoices Export</title>
    <style>
        ...
        .col-no{ width:4%; } .col-ord{ width:10%; } .col-date{ width:12%; } .col-cust{ width:20%; }
        .col-itm{ width:8%; } .col-num{ width:8%; } .col-status{ width:8%; } .col-cashier{ width:12%; }
...
<body>
    <div class="header">
        ...
        <div class="subtitle">INVOICES REPORT</div>
        <div style="font-size:10px; line-height:1.5; margin: 6px 0 4px;">
            This document provides a consolidated view of sales invoices for the selected period and filters.
            It includes totals, amounts paid, outstanding balances, and per-invoice details for auditing and review.
        </div>
