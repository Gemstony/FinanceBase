...
<head>
    <meta charset="UTF-8">
    <title>{{ $subshop->name ?? 'Shop' }} Purchase Returns Export</title>
    <style>
...
<body>
    <div class="header">
        ...
        <div class="subtitle">PURCHASE RETURNS REPORT</div>
        <div style="font-size:10px; line-height:1.5; margin: 6px 0 4px;">
            This document consolidates purchase returns for the selected filters, including totals and refund indicators.
        </div>
