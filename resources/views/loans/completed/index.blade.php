...
@section('title', 'Completed Loans - ' . $subshop->name)
...
<div class="card" style="background: var(--sidebar-bg); color: white; border: none; margin-bottom: 20px;">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="d-none d-md-block text-light"><i class="fas fa-check-circle"></i> Completed Loans</h1>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Completed Loans</li>
    </ol>
</nav>
@stop
...
<div class="container-fluid">
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white">
            <div class="d-flex justify-content-between align-items-center">
                <h3 class="card-title"><strong>List of Paid Off Loans</strong></h3>
                <div class="card-tools">
                    <form action="{{ route('loans.completed.index') }}" method="GET" class="input-group input-group-sm" style="width: 250px;">
                    ...
                    <tbody>
                        ...
                        @forelse($loans as $loan)
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-success text-uppercase">Paid Off</span>
                                </td>
                                <td class="text-right">
                                    <div class="btn-group">
