    ...
    <div>
        <div class="btn-group mr-2">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ route('loans.interest_cycles.export', 'excel') }}">
                    <i class="fas fa-file-excel text-success"></i> Export to Excel
                </a>
                <a class="dropdown-item" href="{{ route('loans.interest_cycles.export', 'pdf') }}">
        ...
        <div class="card mt-4">
            <div class="card-header">
                <a class="d-flex align-items-center justify-content-between text-decoration-none" data-toggle="collapse" href="#importCollapse" role="button" aria-expanded="false" aria-controls="importCollapse">
                    <h5 class="mb-0 text-dark"><i class="fas fa-file-import"></i> Import Interest Cycles</h5>
                        ...
                        <div class="col-md-8">
                            <div class="card border">
                                <div class="card-header bg-info text-white">
                                    <h5 class="mb-0"><i class="fas fa-upload"></i> Bulk Import Interest Cycles</h5>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="{{ route('loans.interest_cycles.import') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-4">
                                            <a href="{{ route('loans.interest_cycles.download-template') }}" class="btn btn-outline-success">
                                                <i class="fas fa-download"></i> Download Excel Template
                                            </a>
                                            <button type="submit" class="btn btn-primary">
                                                <i class="fas fa-file-import"></i> Import Interest Cycles
                                            </button>
                                        </div>
                                    </form>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card border-warning">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="small">
                                        <li><strong>Code</strong> - Unique code for the interest cycle (e.g., DLY, MTH, INST)</li>
                                        <li><strong>Name</strong> - Name of the interest cycle</li>
                                    </ul>
    
                                    <h6 class="fw-bold mt-3">Optional Columns:</h6>
                                    <ul class="small">
                                        <li><strong>Interval Days</strong> - Number of days for the cycle (e.g., 1, 30)</li>
                                        <li><strong>Is Installment Based</strong> - Yes/No or 1/0 (defaults to No)</li>
                                    ...
                                    <ul class="small text-danger">
                                        ...
                                        <li>Is Installment Based accepts: Yes, No, 1, 0, true, false</li>
