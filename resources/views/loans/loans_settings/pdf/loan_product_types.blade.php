...
<head>
    ...
    <title>Loan Product Types - {{ $subshop->name }}</title>
    <style>
...
<body>
    ...
    <div class="header">
        ...
        <div class="header-right">
            <div class="report-title">Loan Product Types</div>
    ...
    <table class="kpi">
        <tr>
            <td>
                <div class="kpi-label">Total Product Types</div>
    ...
    <div class="block-title">Loan Product Types List</div>
    <table>
        <thead>
            <tr>
                <th>#</th>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="6" style="text-align:center; color:#777; padding:10px;">No loan product types found</td>
                </tr>
            @endforelse
        </tbody>
    </table>
    ...
    <div class="footer">
        <div class="footer-left">
            <strong>{{ $shopName }}</strong> | Loan Product Types Report
        </div>
