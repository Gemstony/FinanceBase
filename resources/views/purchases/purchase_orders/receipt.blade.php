...
<head>
    ...
    <title>Purchase #{{ $order->order_no }}</title>
    <style>
        :root { --w: 360px; }
...
<div class="receipt-wrap">
    ...
    <div class="hr"></div>
    <h2 class="title center">PURCHASE</h2>
    ...
    <div class="grid">
        ...
        <div class="label">User:</div><div class="val">{{ $order->creator->name ?? 'System' }}</div>
    ...
    <div class="amount-row total"><span>Grand:</span><span>{{ number_format($order->grand_total,2) }}</span></div>

    <div class="box">
        <div class="grid">
            <div class="label">Paid:</div><div class="val">{{ number_format($paid,2) }}</div>
            <div class="label">Remaining:</div><div class="val">{{ number_format($remaining,2) }}</div>
            <div class="label">Payment Method:</div><div class="val">{{ strtoupper($order->payment_method ?? '-') }}</div>
        </div>
    </div>
