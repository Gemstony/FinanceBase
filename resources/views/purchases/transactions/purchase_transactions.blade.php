...
@section('title', 'Purchase Transactions - ' . $subshop->name)

@section('content_header')
    <div class="card" style="background: var(--sidebar-bg); color: white; border: none; margin-bottom: 20px;">
        <div class="card-body d-flex justify-content-between align-items-center">
            <div>
                <h1 class="d-none d-md-block text-light"><i class="fas fa-exchange-alt"></i> Purchase Transactions</h1>
                <h1 class="d-md-none text-light"><i class="fas fa-exchange-alt"></i> Purchase Transactions</h1>
                <div class="small text-light-50">Shop: {{ $subshop->name }}</div>
            </div>
            <a href="{{ route('purchases.index') }}" class="btn btn-outline-light btn-sm"><i class="fas fa-shopping-cart"></i> Purchases</a>
        </div>
    </div>
@stop
...
<div class="container-fluid">
    <div class="card shadow-sm border-0" style="box-shadow: 0 6px 20px rgba(0,0,0,.06);">
        <div class="card-body">
            ...
            <!-- Filters -->
            <form method="get" action="{{ route('purchase.transactions.index') }}" class="mb-3">
                ...
                <div class="bg-light p-2 rounded border">
                    <div class="form-row align-items-end">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <a class="btn btn-light border" href="{{ route('purchase.transactions.index', ['subshop_id'=>$subshop->id]) }}"><i class="fas fa-undo"></i> Reset</a>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <div class="d-flex justify-content-between align-items-center mb-2">
                ...
                @can('export_purchase_transactions')
                <div class="dropdown">
                    <!-- Export Dropdown -->
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{ route('purchase.transactions.export', ['format' => 'csv'] + request()->query()) }}">
                            <i class="fas fa-file-csv mr-1 text-success"></i> CSV
                        </a>
                        <a class="dropdown-item" href="{{ route('purchase.transactions.export', ['format' => 'excel'] + request()->query()) }}">
                            <i class="fas fa-file-excel mr-1 text-success"></i> Excel
                        </a>
                        <a class="dropdown-item" href="{{ route('purchase.transactions.export', ['format' => 'pdf'] + request()->query()) }}">
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="PurchaseTransactionsTable">
                    <thead class="thead-light" style="background: linear-gradient(90deg, #f7f9fc, #eef3fb); border-bottom: 1px solid #e5ecf6;">
                        <tr>
                            ...
                            <th><i class="fas fa-user mr-1"></i> Supplier</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="badge badge-primary">{{ $transaction->purchaseOrder->order_no ?? '-' }}</span></td>
                            <td>{{ $transaction->purchaseOrder->supplier->name ?? 'No Supplier' }}</td>
                            <td>
...
$(function () {
    ...
    $('#PurchaseTransactionsTable').DataTable({
        "order": [],
        "pageLength": 15,
        "language": {
