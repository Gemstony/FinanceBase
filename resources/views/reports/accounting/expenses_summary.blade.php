...
<div class="card" style="background: var(--sidebar-bg); color: white; border: none; margin-bottom: 20px;">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="d-none d-md-block text-light"><i class="fas fa-receipt"></i> Expenses Summary</h1>
                <h1 class="d-md-none text-light"><i class="fas fa-receipt"></i> Expenses</h1>
                <p class="mb-0 text-light">Accrual-based expenses analytics</p>
            </div>
...
<div class="container-fluid">
    <div class="card shadow-sm border-0" style="box-shadow: 0 6px 20px rgba(0,0,0,.06);">
        <div class="card-body">
            ...
            <form method="get" action="{{ route('reports.accounting.expenses_summary.index') }}" class="mb-3">
                <div class="bg-light p-2 rounded border">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <select class="form-control form-control-sm" id="expense_account_id" name="expense_account_id">
                                <option value="">All</option>
                                @foreach(($expenseAccounts ?? []) as $a)
                                    <option value="{{ $a->id }}" {{ (string) request('expense_account_id') === (string) $a->id ? 'selected' : '' }}>{{ $a->account_code }} - {{ $a->account_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12 d-flex align-items-end">
                            ...
                            <a href="{{ route('reports.accounting.expenses_summary.index') }}" class="btn btn-outline-secondary btn-sm mr-2"><i class="fas fa-times"></i> Clear</a>
            ...
            @if(empty($tree))
                <div class="alert alert-info mb-0">No expense data found for selected period</div>
            @else
                <div class="row mb-3">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div class="h4 mb-0">{{ $fmt($totals['previous_total_expenses'] ?? 0) }}</div>
                                        @if(!empty($prev))
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div class="h4 mb-0">{{ $fmt($totals['difference_total_expenses'] ?? 0) }}</div>
                                    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6 mb-3">
                        <div class="card">
                            <div class="card-header"><strong>Expense Distribution</strong></div>
                            <div class="card-body">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card">
                            <div class="card-header"><strong>Top Expenses</strong></div>
                            <div class="card-body">
                ...
                <div class="card mb-3">
                    <div class="card-header"><strong>Top 5 Expense Accounts</strong></div>
                    <div class="card-body">
...
<script>
    ...
    if (document.getElementById('barChart')) {
        new Chart(document.getElementById('barChart'), {
            type: 'bar',
            data: { labels: barLabels, datasets: [{ label: 'Amount', data: barValues, backgroundColor: '#17a2b8' }] },
    ...
    if (document.getElementById('lineChart')) {
        new Chart(document.getElementById('lineChart'), {
            type: 'line',
            data: { labels: lineLabels, datasets: [{ label: 'Total Expenses', data: lineValues, borderColor: '#dc3545', backgroundColor: 'rgba(220,53,69,0.15)', fill: true, tension: 0.2 }] },
