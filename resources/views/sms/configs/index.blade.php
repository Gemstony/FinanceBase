                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group btn-group-sm">
                                                    ...
                                                    <form action="{{ route('sms.configs.destroy', $config->id) }}" method="POST" class="d-inline" data-swal-confirm>
                                                        @csrf
                                                        @method('DELETE')
        ...
        deleteForms.forEach(function (form) {
            form.addEventListener('submit', function (event) {
                ...
                Swal.fire({
                    ...
                    text: 'Are you sure you want to delete this SMS configuration?',
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            title: 'Deleting...',
                            text: 'Please wait while the configuration is deleted.',
