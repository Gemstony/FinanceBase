...
@section('title', 'Edit SMS Event Mapping')
...
<div class="card" style="background: var(--sidebar-bg); color: white; border: none; margin-bottom: 20px;">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="d-none d-md-block text-light"><i class="fas fa-edit"></i> Edit SMS Event Mapping</h1>
                <h1 class="d-md-none text-light"><i class="fas fa-edit"></i> Edit Event</h1>
                <p class="mb-0 text-light">Modify SMS event mapping details</p>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Edit SMS Event Mapping</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('sms.events.update', $smsEvent->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="event_name" id="event_name" class="form-control" value="{{ $smsEvent->event_name }}" required>
                                <small class="text-muted">Common events: loan.disbursed, payment.received, otp.generated</small>
                            </div>
                        </div>
                        
                        <div class="row mb-3">
                            <label for="template_id" class="col-md-2 col-form-label">Template</label>
                            <div class="col-md-10">
                                <select name="template_id" id="template_id" class="form-select">
                                    <option value="">No Template (Disabled)</option>
                                    @foreach($templates as $template)
                                        <option value="{{ $template->id }}" {{ $smsEvent->template_id == $template->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-10">
                                <div class="form-check">
                                    ...
                                    <input 
                                        ...
                                        value="1"
                                        {{ old('is_enabled', $smsEvent->is_enabled) ? 'checked' : '' }}
                                    >
                        ...
                        <div class="row">
                            <div class="col-md-10 offset-md-2">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Update Event Mapping
                                </button>
