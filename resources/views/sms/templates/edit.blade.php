...
<div class="card" style="background: var(--sidebar-bg); color: white; border: none; margin-bottom: 20px;">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="d-none d-md-block text-light"><i class="fas fa-edit"></i> Edit SMS Template</h1>
                <h1 class="d-md-none text-light"><i class="fas fa-edit"></i> Edit Template</h1>
                <p class="mb-0 text-light">Modify SMS message template</p>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Edit SMS Template</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('sms.templates.update', $smsTemplate->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="name" id="name" class="form-control" value="{{ $smsTemplate->name }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10">
                                <input type="text" name="event" id="event" class="form-control" value="{{ $smsTemplate->event }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-10">
                                <div class="form-check">
                                    ...
                                    <input type="checkbox" name="is_active" id="is_active" class="form-check-input" {{ $smsTemplate->is_active ? 'checked' : '' }} value="1">
